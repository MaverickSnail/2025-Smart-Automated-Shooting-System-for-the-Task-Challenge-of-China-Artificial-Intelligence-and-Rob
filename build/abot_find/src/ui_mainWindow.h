...
public:
    ...
    {
        mainWindow->setWindowTitle(QApplication::translate("mainWindow", "Find-Object", Q_NULLPTR));
        actionExit->setText(QApplication::translate("mainWindow", "Exit", Q_NULLPTR));
        actionAdd_object_from_scene->setText(QApplication::translate("mainWindow", "Add object from scene...", Q_NULLPTR));
        actionStart_camera->setText(QApplication::translate("mainWindow", "Start camera", Q_NULLPTR));
        actionStop_camera->setText(QApplication::translate("mainWindow", "Stop camera", Q_NULLPTR));
        actionSave_objects->setText(QApplication::translate("mainWindow", "Save objects...", Q_NULLPTR));
        actionLoad_objects->setText(QApplication::translate("mainWindow", "Load objects...", Q_NULLPTR));
        actionAbout->setText(QApplication::translate("mainWindow", "About...", Q_NULLPTR));
        actionRestore_all_default_settings->setText(QApplication::translate("mainWindow", "Restore all default settings", Q_NULLPTR));
        actionAdd_objects_from_files->setText(QApplication::translate("mainWindow", "Add objects from files...", Q_NULLPTR));
        actionLoad_scene_from_file->setText(QApplication::translate("mainWindow", "Camera from single file...", Q_NULLPTR));
        actionPause_camera->setText(QApplication::translate("mainWindow", "Pause camera", Q_NULLPTR));
        actionCamera_from_video_file->setText(QApplication::translate("mainWindow", "Camera from video file...", Q_NULLPTR));
        actionRemove_all_objects->setText(QApplication::translate("mainWindow", "Remove all objects", Q_NULLPTR));
        actionCamera_from_directory_of_images->setText(QApplication::translate("mainWindow", "Camera from directory of images...", Q_NULLPTR));
        actionSave_settings->setText(QApplication::translate("mainWindow", "Save settings...", Q_NULLPTR));
        actionLoad_settings->setText(QApplication::translate("mainWindow", "Load settings...", Q_NULLPTR));
        actionCamera_from_TCP_IP->setText(QApplication::translate("mainWindow", "Camera from TCP/IP...", Q_NULLPTR));
        actionLoad_session->setText(QApplication::translate("mainWindow", "Load session...", Q_NULLPTR));
        actionSave_session->setText(QApplication::translate("mainWindow", "Save session...", Q_NULLPTR));
        actionHide_objects_features->setText(QApplication::translate("mainWindow", "Hide objects features", Q_NULLPTR));
        actionShow_objects_features->setText(QApplication::translate("mainWindow", "Show objects features", Q_NULLPTR));
        actionLoad_vocabulary->setText(QApplication::translate("mainWindow", "Load vocabulary...", Q_NULLPTR));
        actionSave_vocabulary->setText(QApplication::translate("mainWindow", "Save vocabulary...", Q_NULLPTR));
        label_5->setText(QApplication::translate("mainWindow", "Camera", Q_NULLPTR));
        label_timeRefreshRate->setText(QApplication::translate("mainWindow", " (0 Hz - 0 Hz)", Q_NULLPTR));
        label_detectorDescriptorType->setText(QString());
        label_nfeatures->setText(QApplication::translate("mainWindow", "0", Q_NULLPTR));
        label_15->setText(QApplication::translate("mainWindow", " features", Q_NULLPTR));
        pushButton_play->setText(QString());
        pushButton_pause->setText(QString());
        pushButton_stop->setText(QString());
        label_frame->setText(QApplication::translate("mainWindow", "0", Q_NULLPTR));
        ...
        dockWidget_parameters->setWindowTitle(QApplication::translate("mainWindow", "Parameters", Q_NULLPTR));
        toolBox->setItemText(toolBox->indexOf(page_1), QApplication::translate("mainWindow", "Dummy", Q_NULLPTR));
        pushButton_restoreDefaults->setText(QApplication::translate("mainWindow", "Restore defaults", Q_NULLPTR));
        dockWidget_objects->setWindowTitle(QApplication::translate("mainWindow", "Objects", Q_NULLPTR));
        pushButton_updateObjects->setText(QApplication::translate("mainWindow", "Update objects", Q_NULLPTR));
        dockWidget_plot->setWindowTitle(QApplication::translate("mainWindow", "Likelihood", Q_NULLPTR));
        dockWidget_statistics->setWindowTitle(QApplication::translate("mainWindow", "Statistics", Q_NULLPTR));
        label_timeIndexing->setText(QApplication::translate("mainWindow", "000", Q_NULLPTR));
        label_timeMatching->setText(QApplication::translate("mainWindow", "000", Q_NULLPTR));
        label_9->setText(QApplication::translate("mainWindow", "ms", Q_NULLPTR));
        label_10->setText(QApplication::translate("mainWindow", "ms", Q_NULLPTR));
        label_16->setText(QApplication::translate("mainWindow", "ms", Q_NULLPTR));
        label_17->setText(QApplication::translate("mainWindow", "Vocabulary size", Q_NULLPTR));
        label_vocabularySize->setText(QApplication::translate("mainWindow", "000", Q_NULLPTR));
        label_18->setText(QApplication::translate("mainWindow", "IP address", Q_NULLPTR));
        label_19->setText(QApplication::translate("mainWindow", "Output detection port", Q_NULLPTR));
        label_ipAddress->setText(QApplication::translate("mainWindow", "0.0.0.0", Q_NULLPTR));
        label_port->setText(QApplication::translate("mainWindow", "0", Q_NULLPTR));
        label_20->setText(QApplication::translate("mainWindow", "Objects detected", Q_NULLPTR));
        label_objectsDetected->setText(QApplication::translate("mainWindow", "000", Q_NULLPTR));
        label_timeHomographies->setText(QApplication::translate("mainWindow", "000", Q_NULLPTR));
        label_21->setText(QApplication::translate("mainWindow", "Input image port", Q_NULLPTR));
        label_port_image->setText(QApplication::translate("mainWindow", "-", Q_NULLPTR));
        label_22->setText(QApplication::translate("mainWindow", "Affine transforms", Q_NULLPTR));
        label_8->setText(QApplication::translate("mainWindow", "Descriptors indexing", Q_NULLPTR));
        label_12->setText(QApplication::translate("mainWindow", "ms", Q_NULLPTR));
        label_minMatchedDistance->setText(QApplication::translate("mainWindow", "000", Q_NULLPTR));
        label_13->setText(QApplication::translate("mainWindow", "Min matched distance", Q_NULLPTR));
        label_14->setText(QApplication::translate("mainWindow", "Max matched distance", Q_NULLPTR));
        label_maxMatchedDistance->setText(QApplication::translate("mainWindow", "000", Q_NULLPTR));
        label_11->setText(QApplication::translate("mainWindow", "Homograhies", Q_NULLPTR));
        label_2->setText(QApplication::translate("mainWindow", "Descriptors extraction", Q_NULLPTR));
        label_3->setText(QApplication::translate("mainWindow", "ms", Q_NULLPTR));
        label_timeExtraction->setText(QApplication::translate("mainWindow", "000", Q_NULLPTR));
        label_4->setText(QApplication::translate("mainWindow", "ms", Q_NULLPTR));
        label->setText(QApplication::translate("mainWindow", "Features detection", Q_NULLPTR));
        label_timeDetection->setText(QApplication::translate("mainWindow", "000", Q_NULLPTR));
        label_7->setText(QApplication::translate("mainWindow", "Descriptors matching", Q_NULLPTR));
        label_6->setText(QApplication::translate("mainWindow", "Total", Q_NULLPTR));
        label_timeTotal->setText(QApplication::translate("mainWindow", "000", Q_NULLPTR));
        label_timeSkewAffine->setText(QApplication::translate("mainWindow", "000", Q_NULLPTR));
        label_23->setText(QApplication::translate("mainWindow", "ms", Q_NULLPTR));
        label_24->setText(QApplication::translate("mainWindow", "Refresh GUI", Q_NULLPTR));
        label_timeRefreshGUI->setText(QApplication::translate("mainWindow", "000", Q_NULLPTR));
        label_25->setText(QApplication::translate("mainWindow", "ms", Q_NULLPTR));
        label_26->setText(QApplication::translate("mainWindow", "Features sub pixel refining", Q_NULLPTR));
        label_timeSubPix->setText(QApplication::translate("mainWindow", "000", Q_NULLPTR));
        label_27->setText(QApplication::translate("mainWindow", "ms", Q_NULLPTR));
    } // retranslateUi
