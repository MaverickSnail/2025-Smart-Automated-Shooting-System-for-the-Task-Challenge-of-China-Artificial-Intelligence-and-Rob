...
public:
    ...
    {
        addObjectDialog->setWindowTitle(QApplication::translate("addObjectDialog", "Add object", Q_NULLPTR));
        label_instruction->setText(QApplication::translate("addObjectDialog", "(Instructions)", Q_NULLPTR));
        comboBox_selection->clear();
        comboBox_selection->insertItems(0, QStringList()
         << QApplication::translate("addObjectDialog", "Select region", Q_NULLPTR)
         << QApplication::translate("addObjectDialog", "Select keypoints", Q_NULLPTR)
        );
        pushButton_cancel->setText(QApplication::translate("addObjectDialog", "Cancel", Q_NULLPTR));
        pushButton_back->setText(QApplication::translate("addObjectDialog", "Back", Q_NULLPTR));
        pushButton_takePicture->setText(QApplication::translate("addObjectDialog", "Take picture", Q_NULLPTR));
        pushButton_next->setText(QApplication::translate("addObjectDialog", "End", Q_NULLPTR));
    } // retranslateUi
