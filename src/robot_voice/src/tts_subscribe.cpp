...
int text_to_speech(const char* src_text, const char* des_path, const char* params)
{
    ...
    {
        /* 获取合成音频 */
        // printf(sessionID, &audio_len, &synth_status, &ret);
...
{
    int         ret                  = MSP_SUCCESS;
    //const char* login_params         = "appid = 594a7b46, work_dir = ~/res/tts/";//登录参数,appid与msc库绑定,请勿随意改动
    // const char* login_params         = "appid = 4a0c9da9, work_dir = ~/res/tts/";//登录参数,appid与msc库绑定,请勿随意改动
    ...
    */
    ...
    /* 用户登录 */
    ret = MSPLogin("13854777288", "123456math", "appid = 4a0c9da9, work_dir = ~/res/tts/");//第一个参数是用户名，第二个参数是密码，第三个参数是登录参数，用户名和密码可在http://open.voicecloud.cn注册获取
    if (MSP_SUCCESS != ret)
    {
