...
#coding: utf-8
'''
Can not have any chinese include annotation
'''
import rospy
...
class navigation_demo:
    def __init__(self):
        ...
        """
        The ar_cb below is from the last competition. His logic is to first identify the task information image, 
        which has three graphics. Then, based on these three graphs, traverse the six task point representation images, find the corresponding images, 
