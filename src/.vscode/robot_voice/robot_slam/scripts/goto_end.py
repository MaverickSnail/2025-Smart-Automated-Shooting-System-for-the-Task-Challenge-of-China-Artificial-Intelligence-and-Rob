...
#from potentital_field.potentital_field_planner import PotentialFieldPlanner
...
class navigation_demo:
    def __init__(self):
        ...
        # self.inflaction_client = Client("/move_base/global_costmap/inflation_layer", timeout=30)
    
    # def set_inflation_radius(self, radius):
    #     # rospy.loginfo(f"Setting inflation radius to {radius}")
    #     self.inflaction_client.update_configuration({"inflation_radius":radius})
...
if __name__ == "__main__":
    ...
    if input == '1':
        # navi.goto(goals[8])
        # navi.set_inflation_radius(0.0)
        navi.goto(goals[12])    # go to end
