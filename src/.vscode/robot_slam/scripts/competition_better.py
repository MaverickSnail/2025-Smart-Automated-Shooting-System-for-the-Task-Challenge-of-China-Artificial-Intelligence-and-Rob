...
if __name__ == "__main__":
    ...
    if input == '1':
        ...
        recognize_flag = True
        rospy.sleep(1)
        print("This is a test where the id is:" + str(find_id))
        print(find_id)
        navi.goto(goals[find_id])
        rospy.sleep(1)
        navi.arrive_announce(id=find_id)
        rospy.sleep(2)

        navi.goto(goals[9])  # go to NO.2 task information point
        rospy.sleep(2)
        recognize_flag = True
        rospy.sleep(3)
        navi.goto(goals[find_id])
        navi.arrive_announce(find_id)
        rospy.sleep(1)
